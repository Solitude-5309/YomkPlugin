...
typedef YomkPluginInterface *(*YomkPluginCreateInstanceFunc)(const char *instance_name, const char *config_file);
...
#define YOMK_PLUGIN_EXPORT(MetaFn, CreateFn, DeleteFn)                                     \
    ...
    extern "C" YomkPluginInterface *yomk_plugin_create_instance(const char *instance_name, \
                                                                const char *config_file)   \
    {                                                                                      \
        return CreateFn(instance_name, config_file);                                       \
    }                                                                                      \
